\chapter{Circuito analogico}
	...
	\section{Risultati}
		...
		\screenshot[width=\textwidth]{analog/screens/1,0V}{Input e output del clipper analogico con $A = 1V$}
		\pagebreak
		\vspace*{-30px}
		\screenshot[width=\textwidth]{analog/screens/1,5V}{Input e output del clipper analogico con $A = 1,5V$}
		\screenshot[width=\textwidth]{analog/screens/2,0V}{Input e output del clipper analogico con $A = 2V$}
		\pagebreak
