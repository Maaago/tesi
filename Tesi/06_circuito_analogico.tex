%TODO da mettere come appendice?
\chapter{Circuito analogico}
	...
	\section{Risultati}
		...
		\screenshot[width=\textwidth]{analog/screens/0,5V}{Input e output del clipper analogico con $V = 0,5V$}
		\pagebreak
		\vspace*{-30px}
		\screenshot[width=\textwidth]{analog/screens/1,0V}{Input e output del clipper analogico con $V = 1,0V$}
		\screenshot[width=\textwidth]{analog/screens/1,2V}{Input e output del clipper analogico con $V = 1,2V$}
		\pagebreak
		\vspace*{-30px}
		\screenshot[width=\textwidth]{analog/screens/1,4V}{Input e output del clipper analogico con $V = 1,4V$}
		\screenshot[width=\textwidth]{analog/screens/1,6V}{Input e output del clipper analogico con $V = 1,6V$}
		\pagebreak
		\vspace*{-30px}
		\screenshot[width=\textwidth]{analog/screens/1,8V}{Input e output del clipper analogico con $V = 1,8V$}
		\screenshot[width=\textwidth]{analog/screens/2,0V}{Input e output del clipper analogico con $V = 2,0V$}
		\pagebreak
		\vspace*{-30px}
		\screenshot[width=\textwidth]{analog/screens/2,2V}{Input e output del clipper analogico con $V = 2,2V$}
