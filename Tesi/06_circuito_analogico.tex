...
\chapter{Circuito analogico}
	...
	\section{Risultati}
		...
		\screenshot[width=\textwidth]{analog/1,0V}{Input e output del clipper analogico con $V = 1,0V$}
		\pagebreak
		\vspace*{-30px}
		\screenshot[width=\textwidth]{analog/1,1V}{Input e output del clipper analogico con $V = 1,1V$}
		\screenshot[width=\textwidth]{analog/1,2V}{Input e output del clipper analogico con $V = 1,2V$}
		\pagebreak
		\vspace*{-30px}
		\screenshot[width=\textwidth]{analog/1,3V}{Input e output del clipper analogico con $V = 1,3V$}
		\screenshot[width=\textwidth]{analog/1,4V}{Input e output del clipper analogico con $V = 1,4V$}
		\pagebreak
		\vspace*{-30px}
		\screenshot[width=\textwidth]{analog/1,5V}{Input e output del clipper analogico con $V = 1,5V$}
