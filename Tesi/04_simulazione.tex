\chapter{Simulazione}
	...
	\section{Grafici}
		...
		\subsection{Grafico tempo d'esecuzione-Valore di L}
			...
			\grafico{L-time/1,0V}{Grafico tempo d'esecuzione-Valore di L di un segnale sinusoidale con $A = 1,0V$}
			\graficospace
			\grafico{L-time/1,2V}{Grafico tempo d'esecuzione-Valore di L di un segnale sinusoidale con $A = 1,2V$}
			\graficospace
			\grafico{L-time/1,4V}{Grafico tempo d'esecuzione-Valore di L di un segnale sinusoidale con $A = 1,4V$}
			\graficospace
			\grafico{L-time/1,45V}{Grafico tempo d'esecuzione-Valore di L di un segnale sinusoidale con $A = 1,45V$}
			\graficospace
			\grafico{L-time/1,5V}{Grafico tempo d'esecuzione-Valore di L di un segnale sinusoidale con $A = 1,5V$}
			\graficospace
