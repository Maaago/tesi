	...
	\section{Grafici}
		\subsection{Grafici input-output}
			...
			\subsubsection{Onda sinusoidale}
				...
				\grafico{in-out/ampiezze/100Hz_1,6V_L=0-iterations}{Grafico delle iterazioni con $f = 100Hz$, $A = 1,5V$ e $L = 0$}
		...
		\subsection{Grafico iterazioni-valore di L}
			...
			\grafico{L-iterations/100Hz/1,0V}{Grafico iterazioni-valore di L con $f = 100\;Hz$ e $A = 1,0V$}
			\graficospace
			\grafico{L-iterations/100Hz/1,45V}{Grafico iterazioni-valore di L con $f = 100\;Hz$ e $A = 1,45V$}
			\graficospace
			\grafico{L-iterations/100Hz/1,5V}{Grafico iterazioni-valore di L con $f = 100\;Hz$ e $A = 1,5V$}
			\graficospace
			\grafico{L-iterations/1000Hz/1,0V}{Grafico iterazioni-valore di L con $f = 1000\;Hz$ e $A = 1,0V$}
			\graficospace
			\grafico{L-iterations/1000Hz/1,45V}{Grafico iterazioni-valore di L con $f = 1000\;Hz$ e $A = 1,45V$}
			\graficospace
			\grafico{L-iterations/1000Hz/1,5V}{Grafico iterazioni-valore di L con $f = 1000\;Hz$ e $A = 1,5V$}
			\graficospace
			...
			\grafico{L-iterations/noise/3,0V}{Grafico iterazioni-valore di L con $A = 3,0V$}
			\graficospace
			\grafico{L-iterations/noise/3,5V}{Grafico iterazioni-valore di L con $A = 3,5V$}
			\graficospace
			\grafico{L-iterations/noise/4,0V}{Grafico iterazioni-valore di L con $A = 4,0V$}
			\graficospace
		...
		\subsection{Grafico tempo d'esecuzione-Valore di L}
			...
			\grafico{L-time/1,0V_no_optimization}{Grafico tempo d'esecuzione-Valore di L con $A = 1V$ con calcolo dello jacobiano per $L = 0$}
			\graficospace
			...
			\grafico{L-time/1,0V}{Grafico tempo d'esecuzione-Valore di L con $A = 1,0V$}
			\graficospace
			\grafico{L-time/1,2V}{Grafico tempo d'esecuzione-Valore di L con $A = 1,2V$}
			\graficospace
			\grafico{L-time/1,4V}{Grafico tempo d'esecuzione-Valore di L con $A = 1,4V$}
			\graficospace
			\grafico{L-time/1,45V}{Grafico tempo d'esecuzione-Valore di L con $A = 1,45V$}
			\graficospace
			\grafico{L-time/1,5V}{Grafico tempo d'esecuzione-Valore di L con $A = 1,5V$}
			\graficospace
